...
urlpatterns=[
 ...
 path("methodology/",core.methodology,name="methodology"),path("roadmap/",core.roadmap,name="roadmap"),path("manifesto/",core.manifesto,name="manifesto"),path("methodology/changelog/",core.changelog,name="changelog"),path("seasons/<slug:slug>/",core.season_archive,name="season_archive"),path("admin/",admin.site.urls),
]
