...
A player's name should not affect the score.

Neither should popularity, media attention, previous awards or reputation.
...
## Different roles deserve different standards

Football does not have one job.

A goalkeeper is not asked to do what a striker does.

A defender should not need goals to receive recognition.
...
Ten successful actions against one opponent may not represent the same performance as ten against another.

A Champions League knockout match is not identical to every domestic fixture.
...
You should never have to guess what it is.
...
* how those statistics compare with players in the same role;
* which contextual adjustments were applied;
* which formula produced the score;
* why that score produced the player's rank.

The final number is not the explanation.

It is the result of the explanation.
...
If the calculation cannot be reproduced, it should not decide who wins.

---

## Missing data is not bad performance
...
The ranking is not created once at the end of the season.
...
Not that everyone must agree with the result.

But that everyone can understand it.

**You may disagree with the formula.**

**You should never have to wonder how the winner was chosen.**
